...
{
	$configViewer = (T4\Helper\J3J4::isJ3()) ? 'controller=config.display.modules' : 'view=modules';
...
if ($count)
{
	...
	Factory::getDocument()->addScript(\T4\Helper\Path::findInTheme('js/system/frontediting.js', true));
}
