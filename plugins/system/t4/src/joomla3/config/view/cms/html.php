...
abstract class ConfigViewCmsHtml extends JViewHtml
{
	...
	public function loadTemplate($tpl = null)
	{
		...
		$component = JApplicationHelper::getComponentName();
		$component = preg_replace('/[^A-Z0-9_\.-]/i', '', $component);
		$paths[] = T4PATH_LOCAL . '/html/' . $component . '/' . $this->getName();
		$paths[] = T4PATH_TPL . '/html/' . $component . '/' . $this->getName();
		$paths[] = T4PATH_BASE . '/html/' . $component . '/' . $this->getName();
		$paths[] = JPATH_COMPONENT . '/view/' . $this->getName() . '/tmpl';

		$this->_path['template'] = $paths;
