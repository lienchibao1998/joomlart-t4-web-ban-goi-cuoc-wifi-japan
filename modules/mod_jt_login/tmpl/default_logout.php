...
<?php if ($params->get('greeting', 1)) : ?>
	...
	<?php if (!$params->get('name', 0)) : ?>
		<?php echo Text::sprintf('mod_jt_login_HINAME', htmlspecialchars($user->get('name'), ENT_COMPAT, 'UTF-8')); ?>
	<?php else : ?>
		<?php echo Text::sprintf('mod_jt_login_HINAME', htmlspecialchars($user->get('username'), ENT_COMPAT, 'UTF-8')); ?>
	<?php endif; ?>
	</div>
<?php endif; ?>
<?php if ($params->get('profilelink', 0)) : ?>
	<ul class="mod-login-logout__options list-unstyled">
		<li>
			...
			<?php echo Text::_('mod_jt_login_PROFILE'); ?></a>
		</li>
	</ul>
<?php endif; ?>
