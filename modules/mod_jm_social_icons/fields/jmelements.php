...
class JFormFieldJMElements extends JFormField
{
	...
	public function setup(SimpleXMLElement $element, $value, $group = null)
	{
		...
		$lang['element_empty_required_message'] = 'Error';
		...
		if (!empty($this->element['element_empty_required_message'])) {
			$lang['element_empty_required_message'] = (string)JText::_($this->element['element_empty_required_message']);
		}
